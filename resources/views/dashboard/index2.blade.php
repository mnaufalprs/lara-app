...
@section('mainClass')
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
    <div
        class="border-2 border-indigo-100 rounded-lg dark:border-gray-600 h-32 md:h-64 md:p-4 bg-indigo-100"
    >
    
    
    </div>
    <div
        class="border-2 rounded-lg border-gray-300 dark:border-gray-600 h-32 md:h-64"
    ></div>
    <div
  ...
  {{-- end tabel data pengukuran --}}
    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
      {{-- start grafik chart --}}
      <div
          class="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 h-48 md:h-72 md:p-4"
      >
        
        <div class="flex justify-between">
            <div>
              <h5 class="leading-none text-1x1 font-bold text-gray-900 dark:text-white pb-2">32.4k</h5>
              <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Users this week</p>
            </div>
            <div
